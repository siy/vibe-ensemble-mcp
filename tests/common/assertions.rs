...
impl IssueAssertions {
    ...
    pub fn assert_reasonable_resolution_time(issue: &Issue, max_resolution_time: Duration) {
        if issue.status() == IssueStatus::Done {
            let resolution_time = issue.time_to_resolution()
...
mod tests {
    use super::*;
    use crate::common::fixtures::{TestScenarios, TestDataFactory};
    ...
    fn test_performance_assertions() {
        ...
        let result = PerformanceAssertions::assert_completes_within(
